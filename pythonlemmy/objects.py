...
class ListCommunities(ViewObject):
...
class RegistrationApplication(ViewObject):
...
class AdminPurgeComment(ViewObject):
...
class DeleteComment(ViewObject):
...
class CreateCommunity(ViewObject):
...
class AdminPurgeCommunity(ViewObject):
...
class ModRemoveCommunity(ViewObject):
...
class LocalSiteUrlBlocklist(ViewObject):
...
class CommentAggregates(ViewObject):
...
class GetSiteMetadata(ViewObject):
...
class ResolveCommentReport(ViewObject):
...
class DeleteCommunity(ViewObject):
...
class GetPersonMentions(ViewObject):
...
class ModHideCommunity(ViewObject):
...
class HideCommunity(ViewObject):
...
class RemoveCommunity(ViewObject):
...
class EditCustomEmoji(ViewObject):
...
class PersonMention(ViewObject):
...
class CreatePrivateMessageReport(ViewObject):
...
class ReadableFederationState(ViewObject):
...
class BlockInstance(ViewObject):
...
class PasswordChangeAfterReset(ViewObject):
...
class PersonAggregates(ViewObject):
...
class MarkCommentReplyAsRead(ViewObject):
...
class LocalUserVoteDisplayMode(ViewObject):
...
class ChangePassword(ViewObject):
...
class ResolveObject(ViewObject):
...
class ModAddCommunity(ViewObject):
...
class ListPrivateMessageReports(ViewObject):
...
class SiteAggregates(ViewObject):
...
class CreatePostReport(ViewObject):
...
class PostAggregates(ViewObject):
...
class GetReportCount(ViewObject):
...
class DeletePrivateMessage(ViewObject):
...
class ListPostReports(ViewObject):
...
class ModFeaturePost(ViewObject):
...
class GetPersonDetails(ViewObject):
...
class AddModToCommunity(ViewObject):
...
class ApproveRegistrationApplication(ViewObject):
...
class FollowCommunity(ViewObject):
...
class GetPrivateMessages(ViewObject):
...
class RemoveComment(ViewObject):
...
class MarkPostAsRead(ViewObject):
...
class ResolvePrivateMessageReport(ViewObject):
...
class PrivateMessage(ViewObject):
...
class CreateCustomEmoji(ViewObject):
...
class InstanceWithFederationState(ViewObject):
...
class CommunityAggregates(ViewObject):
...
class EditCommunity(ViewObject):
...
class ListPostLikes(ViewObject):
...
class ModRemovePost(ViewObject):
...
class BanFromCommunity(ViewObject):
...
class CreatePostLike(ViewObject):
...
class EditPrivateMessage(ViewObject):
...
class SaveUserSettings(ViewObject):
...
class CreatePrivateMessage(ViewObject):
...
class LocalSiteRateLimit(ViewObject):
...
class ListCommentLikes(ViewObject):
...
class CustomEmojiKeyword(ViewObject):
...
class ModlogListParams(ViewObject):
...
class ModRemoveComment(ViewObject):
...
class ModBanFromCommunity(ViewObject):
...
class MarkPersonMentionAsRead(ViewObject):
...
class PrivateMessageReport(ViewObject):
...
class PasswordReset(ViewObject):
...
class CreateCommentReport(ViewObject):
...
class CreateCommentLike(ViewObject):
...
class DeleteAccount(ViewObject):
...
class MarkPrivateMessageAsRead(ViewObject):
...
class PurgeCommunity(ViewObject):
...
class ModTransferCommunity(ViewObject):
...
class OpenGraphData(ViewObject):
...
class BlockCommunity(ViewObject):
...
class AdminPurgePost(ViewObject):
...
class ResolvePostReport(ViewObject):
...
class CreateComment(ViewObject):
...
class ListRegistrationApplications(ViewObject):
...
class DistinguishComment(ViewObject):
...
class CommentReport(ViewObject):
...
class DeleteCustomEmoji(ViewObject):
...
class ListCommentReports(ViewObject):
...
class GetRegistrationApplication(ViewObject):
...
class AdminPurgePerson(ViewObject):
...
class TransferCommunity(ViewObject):
